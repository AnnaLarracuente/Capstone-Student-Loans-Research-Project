...
proc sgplot data=_BarChartTaskData;
	by STUDENTLOANS_BIN;
	title height=16pt "Impact of Student Loan Debt on Ability to Travel Outside of the US, By Generation (2023)";
	footnote2 justify=left height=12pt 
		"0 = Do Not Have Student Loans, 1 = Have Student Loans";
	vbar 'TRAV_US?'n / group=GEN groupdisplay=cluster datalabel fillType=gradient;
	xaxis label="Have Participants Travelled Outside of the US in the Last Year (2022-2023)?";
	yaxis grid;
run;

...
proc corr data=Work.SortTempTableSorted pearson nosimple plots=matrix;
	var SEX_BIN MAR_STAT_CLASS IND_ANN_INC_LOW IND_ANN_INC_HI IND_ANN_INC_AVG 
		IND_MON_INC_AVG HSD_GED_BIN BACH_DEG_BIN HIGHER_ED_BIN BACH_HIGHER_ED_BIN 
		CURR_STUDENT_BIN OWN_CAR_BIN HOUSING_CLASS HOUSING_BIN MULTI_GEN_BIN 
		CHILDREN_BIN PETS_BIN VACATION_BIN TRAV_STATE_BIN TRAV_US_BIN MOV_BIN HOB_BIN 
		DINEOUT_BIN ORDERIN_BIN DONATIONS_BIN 'MON_ESS_EXP_MIN ($)'n 
		...
		ANN_SLD_INC_DTIRAT MON_SLD_INC_DTIRAT ANN_SLD_INC_DTIRAT_PRCNT GEN_CLASS;
	by STUDENTLOANS_BIN;
run;

...
proc sgplot data=_BarChartTaskData;
	by STUDENTLOANS_BIN;
	title height=14pt "Impact of Student Loan Debt on Annual Nonessential Expenses of Americans, By Generation (2023)";
	footnote2 justify=left height=12pt 
		"0 = Do Not Have Student Loans, 1 = Have Student Loans";
	vbar 'ANN_NONESS_EXP ($)'n / group=GEN groupdisplay=cluster dataskin=gloss;
	xaxis label="Annual Nonessential Expenses ($)";
	yaxis grid;
run;
